...
import '../card/cart_card.dart';
import '../components/draggable_bottom_sheet.dart';
import '../components/text/ctext.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class SheetCart extends StatefulWidget {
  SheetCart({
    Key? key,
  }) : super(key: key);

  @override
  State<SheetCart> createState() => _SheetCartState();
}

class _SheetCartState extends State<SheetCart> {
