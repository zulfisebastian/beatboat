                                                        ...
                                                        child: _data.stock! > 0
                                                            ? Obx(
                                                                () => Container(
                                                                  ...
                                                                  child: Center(
                                                                    child: _product.listCart.where((e) => e.product_id == _data.id).length >
                                                                            0
                                                                        ? CText(
                                                                            _product.getCartQtyLength(_data),
                                                                            color:
                                                                                Colors.white,
                                                                          )
                                                                        : Icon(
